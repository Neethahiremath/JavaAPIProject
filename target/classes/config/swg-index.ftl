...
<head>
  ...
  <style type="text/css">
    ...
    .swagger-section #input_authHeader {
    ...
    $(function () {
      ...
      <#if showAuth>
        ...
        function addAuthorizationHeader() {
          ...
          if(key && key.trim() != "") {
              var headerAuth = new SwaggerClient.ApiKeyAuthorization("Authorization", key.startsWith("Bearer ") ? key : "Bearer " + key, "header");
...
<div id='header'>
  <div class="swagger-ui-wrap">
    ...
    <form id='api_selector'>
      ...
      <input type="hidden" id="input_headerSelect" value="1" /> <!-- for Auth type dropdown list -->
      <div class='input' id="header_1"><input placeholder="OAuth Access Token" id="input_authHeader" name="authHeader" type="text"/></div>
